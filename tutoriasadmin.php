...
<!-- Page Content -->
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Actividad Tutoria</li>
      </ol>
             ...
             ?>
              ...
              <tr>
                ...
                <td><?php echo $row['ID']; ?></td>
                   <td> <a href="tutoriaregistro.php"> <button type="button" class="btn btn-success">Inscribir</button></a> </td>
                <?php
                  echo "<td> <a href='modificartutoria.php?ID=".$row['ID']."'> <button type='button' class='btn btn-info''>Modificar</button></a> </td>";
                                  
                  
                  ?>
                <?php
                  echo "<td> <a href='eliminartutoria.php?ID=".$row['ID']."'> <button type='button' class='btn btn-danger''>Eliminar</button></a> </td>";
