...
<!-- Page Content -->
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ciclo talleres</li>
      </ol>
       ...
       <?php
             ...
             ?>
              ...
              <tr>
                ...
                <td> <a href="ciclotalleresregistro.php"> <button type="button" class="btn btn-success">Inscribir</button></a> </td>
                
                <?php
                  echo "<td> <a href='modificarciclodetalleres.php?ID=".$row['ID']."'> <button type='button' class='btn btn-info''>Modificar</button></a> </td>";
                                  
                  
                  ?>
                <?php
                  echo "<td> <a href='eliminarciclotalleres.php?ID=".$row['ID']."'> <button type='button' class='btn btn-danger''>Eliminar</button></a> </td>";
