...
<!-- Page Content -->
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="discapacidadadmin.php">Talleres discapacidad</a>
        </li>
...
<form action="registrodiscapacidad.php" class="formoid-flat-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Lato', sans-serif;color:#666666;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Modificar curso</h2></div>
