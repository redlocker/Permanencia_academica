...
<!-- Page Content -->
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Acompañamiento a la discapacidad</li>
      </ol>
       ...
       <?php
             ...
             ?>
              ...
              <tr>
                ...
                <td> <a href="discapacidadregistro.php"> <button type="button" class="btn btn-success">Inscribir</button></a> </td>
                
                <?php
                  echo "<td> <a href='modificardiscapacidad.php?ID=".$row['ID']."'> <button type='button' class='btn btn-info''>Modificar</button></a> </td>";
                                  
                  
                  ?>
                <?php
                  echo "<td> <a href='eliminardiscapacidad.php?ID=".$row['ID']."'> <button type='button' class='btn btn-danger''>Eliminar</button></a> </td>";
