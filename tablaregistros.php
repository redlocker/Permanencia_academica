       ...
       <?php
             ...
             ?>
              ...
              <tr>
                ...
                <?php
                  echo "<td> <a href='modifcarcursos.php?ID=".$row['ID']."'> <button type='button' class='btn btn-info''>Modificar</button></a> </td>";
                                  
                  
                  ?>
                <?php
                  echo "<td> <a href='eliminarinscripcion.php?ID=".$row['ID']."'> <button type='button' class='btn btn-danger''>Eliminar</button></a> </td>";
