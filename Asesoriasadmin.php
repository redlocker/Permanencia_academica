             ...
             ?>
              ...
              <tr>
                ...
                <td><?php echo $row['ID']; ?></td>
                   <td> <a href="inscripcion_tutorias.html"> <button type="button" class="btn btn-success">Inscribir</button></a> </td>
                <?php
                  echo "<td> <a href='modificarasesoria.php?ID=".$row['ID']."'> <button type='button' class='btn btn-info''>Modificar</button></a> </td>";
                                  
                  
                  ?>
                <?php
                  echo "<td> <a href='eliminarasesoria.php?ID=".$row['ID']."'> <button type='button' class='btn btn-danger''>Eliminar</button></a> </td>";
