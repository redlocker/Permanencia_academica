...
<!-- Page Content -->
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tabla de reportes</li>
      </ol>
             ...
             ?>
              ...
              <tr>
                ...
                <td><?php echo $row['ID']; ?></td>
                     <?php
                  echo "<td> <a href='eliminarreporte.php?ID=".$row['ID']."'> <button type='button' class='btn btn-danger''>Eliminar</button></a> </td>";
